...
class Office_Base_Controller extends Template_Controller
{
    ...
    public function __construct() {
        ...
        if ($uri == 'districts') {
            ...
            $districts = array('toggled' => 'toggled', 'active' => 'active', 'display-block' => 'display-block');
            
            $offices = array('toggled' => '', 'active' => '', 'display-block' => '');
            
            $office_budgets = array('toggled' => '', 'active' => '', 'display-block' => '');
            
            $categories = array('toggled' => '', 'active' => '', 'display-block' => '');
            
            $suppliers = array('toggled' => '', 'active' => '', 'display-block' => '');
            
            $items = array('toggled' => '', 'active' => '', 'display-block' => '');
            
            $purchases = array('toggled' => '', 'active' => '', 'display-block' => '');
            
            $transactions = array('toggled' => '', 'active' => '', 'display-block' => '');
            
            $requests = array('toggled' => '', 'active' => '', 'display-block' => '');
            
            $users = array('toggled' => '', 'active' => '', 'display-block' => '');
            $this->template->uriClass = (object)compact('dashboard', 'districts', 'offices', 'office_budgets', 'categories', 'suppliers', 'items', 'purchases', 'transactions', 'requests', 'users');
        } 
        else if ($uri == 'offices') {
            $dashboard = '';
            
            $districts = array('toggled' => '', 'active' => '',);
            
            $offices = array('toggled' => 'toggled', 'active' => 'active',);
