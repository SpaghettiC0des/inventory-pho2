                                    ...
                                    <div data-bind = "with : profileVM" class="pmbb-edit">
									 <form data-bind = "submit : handleSubmit" action="" class="form-horizontal">
                                        <dl class="dl-horizontal">
                                            ...
                                            <dd>
                                                <div class="fg-line">
                                                    <input data-bind = "value : name" type="text" class="form-control" placeholder="eg. Mallinda Hollaway"  required>
                                                </div>
                                        ...
                                        <div class="m-t-30">
                                            <button data-bind="submit: handleSubmit" class="btn btn-primary btn-sm">Save</button>
                                            <button data-pmb-action="reset" class="btn btn-link btn-sm">Cancel</button>
                                        </div>
                                    </div>
									</form>
                                ...
                                <div class="pmbb-body p-l-30">
									...
									<form data-bind = "submit : handleSubmit" action="" class="form-horizontal">
                                        <dl class="dl-horizontal">
                                            ...
                                            <dd>
                                                <div class="fg-line">
                                               <input data-bind="value : mobile" type="text" class="form-control" placeholder="eg. 00971 12345678 9" required>
                                                </div>
                                            </dd>
                                        </dl>
                                        <dl class="dl-horizontal">
                                            ...
                                            <dd>
                                                <div class="fg-line">
                                                    <input data-bind="value : email" type="email" class="form-control" placeholder="eg. malinda.h@gmail.com" required>
                                                </div>
                                            </dd>
                                        </dl>
                                        <dl class="dl-horizontal">
                                            ...
                                            <dd>
                                                <div class="fg-line">
                                                    <input data-bind="value : twitter" type="text" class="form-control" placeholder="eg. @malinda" required>
                                                </div>
                                            </dd>
                                        </dl>
                                        <dl class="dl-horizontal">
                                            ...
                                            <dd>
                                                <div class="fg-line">
                                                    <input data-bind="value : skype" type="text" class="form-control" placeholder="eg. malinda.hollaway" required>
                                                </div>
                                            </dd>
                                        </dl>
