                            ...
                            <table class="table table-stripe table-hover">
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <th></th>
                                        <th></th>
                                        <th data-bind = "text: fullDetails()[0][0].grand_total"></th>
                                    </tr>
                                </tfoot>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" id="transaction-ref-no" name="transaction-ref-no" class="form-control input-mask" data-mask="A0-000-0000" placeholder="A0-000-0000">                            
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            ...
                            <select data-bind="selectPicker: office_id, 
                                 optionsText: 'name', optionsCaption: 'Select Office',
                                    selectPickerOptions: { optionsArray: $parent.dataObjects.allOffices }" 
