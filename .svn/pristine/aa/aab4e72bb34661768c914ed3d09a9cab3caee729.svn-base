                    ...
                    <ul class="main-menu">
                        ...
                        <li class="sub-menu">
                            ...
                            <ul>
                                ...
                                <li><a href="<?php echo url::site(); ?>items">All Items</a></li>
                                <li><a href="<?php echo url::site(); ?>items">On Stock</a></li>
                                <li><a href="<?php echo url::site(); ?>items">Out of Stock</a></li>
                                <li><a href="<?php echo url::site(); ?>items">Expired</a></li>
